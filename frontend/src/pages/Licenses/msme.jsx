...
const OverviewContent = () => (
    <section id="msme-overview-content" className="py-20 bg-slate-50/50 scroll-mt-24">
...
const ClassificationContent = () => (
    <section id="msme-classification-content" className="py-20 bg-white scroll-mt-24">
        <div className="max-w-7xl mx-auto px-4">
...
const BenefitsContent = () => (
    <section id="msme-benefits-content" className="py-20 bg-slate-50/50 scroll-mt-24">
        <div className="max-w-7xl mx-auto px-4">
...
const DocumentsContent = () => (
    <section id="msme-documents-content" className="py-20 bg-white scroll-mt-24">
        <div className="max-w-7xl mx-auto px-4">
