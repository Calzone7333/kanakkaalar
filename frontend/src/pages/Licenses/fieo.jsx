...
const plans = [
    {
        "title": "Individual / Service Providers",
        "price": "₹6,250/-",
        "description": "Starting subscription",
        "features": [
    ...
    },
    {
        ...
        "price": "₹50,000/-",
        "description": "High-scale enterprise",
        "features": [
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
                <div className="space-y-8 text-slate-600 leading-relaxed italic">
                    ...
                    <div className="flex flex-wrap gap-5 pt-2">
                        <span className="px-4 py-2 bg-white rounded-lg border border-slate-200 text-sm font-semibold text-slate-700 shadow-sm uppercase italic">Apex Export Body</span>
                        <span className="px-4 py-2 bg-white rounded-lg border border-slate-200 text-sm font-semibold text-slate-700 shadow-sm uppercase italic">DGFT RCMC Authority</span>
                    </div>
                </div>
                <div className="p-8 bg-white border border-slate-100 rounded-[40px] shadow-2xl relative overflow-hidden group">
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed italic mb-6">FIEO membership opens doors to international trade portal statistics, mfn tariffs, and preferential duty info for 200+ countries.</p>
                    <div className="grid grid-cols-2 gap-5">
                        <div className="p-4 bg-slate-50 rounded-2xl flex flex-col items-center">
                            ...
                            <span className="text-sm font-bold text-slate-700 uppercase">Verified</span>
                        </div>
                        <div className="p-4 bg-slate-50 rounded-2xl flex flex-col items-center">
                            <TrendingUp size={20} className="text-[#1A7F7D] mb-2" />
                            <span className="text-sm font-bold text-slate-700 uppercase">Incentives</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
                {rcmcEligibility.map((item, i) => (
                    <div key={i} className="p-8 bg-slate-50 rounded-2xl border border-slate-100 flex flex-col items-center text-center group hover:bg-white hover:shadow-lg transition-all">
                        <item.icon size={24} className="text-[#1A7F7D] mb-4 group-hover:scale-110 transition-transform" />
                        <h6 className="font-bold text-slate-800 text-lg mb-2 uppercase italic">{item.title}</h6>
                        <p className="text-sm text-slate-500 italic leading-relaxed">{item.detail}</p>
                    </div>
                ))}
            </div>
            <div className="grid md:grid-cols-2 gap-10">
                <div className="p-10 bg-slate-900 rounded-[48px] text-white flex gap-10 items-center border-l-8 border-l-[#C59B4E] shadow-xl">
                    <Users size={48} className="text-[#C59B4E] shrink-0" />
                    <div>
                        <h5 className="font-bold text-lg tracking-widest uppercase italic mb-2">Ordinary Membership</h5>
                        <p className="text-sm text-slate-400 italic leading-relaxed">Designated for startups and entities that have recently entered the international trade ecosystem.</p>
                    </div>
                </div>
                <div className="p-10 bg-slate-900 rounded-[48px] text-white flex gap-10 items-center border-l-8 border-l-[#C59B4E] shadow-xl">
                    <TrendingUp size={48} className="text-[#C59B4E] shrink-0" />
                    <div>
                        <h5 className="font-bold text-lg tracking-widest uppercase italic mb-2">Partner Membership</h5>
                        <p className="text-sm text-slate-400 italic leading-relaxed">For established entities with a proven track record. Features higher access and fee modules.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-10">
                {fieoServices.map((s, i) => (
                    <div key={i} className="p-8 bg-slate-50 rounded-[32px] border border-slate-100 flex gap-10 items-center hover:bg-white hover:shadow-xl transition-all h-full">
                        ...
                        <div>
                            <h6 className="font-bold text-slate-800 text-lg mb-2 uppercase italic tracking-tighter">{s.title}</h6>
        ...
        <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-10">
                {fieoDocuments.map((doc, i) => (
                    <div key={i} className="p-8 bg-white rounded-2xl border border-slate-100 flex gap-5 items-start shadow-sm hover:shadow-md transition-all">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-400 italic leading-relaxed">{doc.detail}</p>
                        </div>
                    </div>
                ))}
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
                <div className="order-2 lg:order-1">
                    ...
                    <div className="grid sm:grid-cols-2 gap-10 pt-4">
                        {fieoWhyBizzfiling.map((s, i) => (
                            <div key={i} className="p-8 bg-white rounded-[32px] border border-slate-100 shadow-sm transition-all hover:-translate-y-1">
                ...
                <div className="order-1 lg:order-2 bg-[#103B3E] p-12 rounded-[50px] shadow-3xl text-white flex flex-col items-center text-center">
                    ...
                    <p className="text-slate-400 text-sm italic mb-8">"Facilitating export credentials for India's leading multi-product trade houses."</p>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                        <div className="w-full lg:w-3/5 space-y-8">
                            ...
                            <div className="flex gap-10 pt-2">
                                ...
                                <div className="flex items-center gap-5 text-white/90 text-sm md:text-sm font-bold">
                                    <Rocket size={18} className="text-[#C59B4E]" /> Fast Processing
                                </div>
                            </div>
                        </div>
                        <div className="w-full max-w-sm">
                            <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-100">
                                <div className="p-8 md:p-8">
                                    <h3 className="text-xl font-bold text-slate-800 text-center mb-6">Apply RCMC</h3>
