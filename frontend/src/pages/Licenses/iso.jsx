...
const OverviewContent = () => (
    <section id="iso-overview-content" className="py-16 bg-slate-50/50 scroll-mt-24">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6 text-slate-600 leading-relaxed">
                    ...
                    <div className="flex flex-wrap gap-3 pt-2">
                        <span className="px-4 py-2 bg-white rounded-lg border border-slate-200 text-xs font-semibold text-slate-700 shadow-sm">IAF Accredited</span>
                        <span className="px-4 py-2 bg-white rounded-lg border border-slate-200 text-xs font-semibold text-slate-700 shadow-sm">Govt Recognized</span>
                        <span className="px-4 py-2 bg-white rounded-lg border border-slate-200 text-xs font-semibold text-slate-700 shadow-sm">Global Scale</span>
                    </div>
                </div>
                <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-xl relative overflow-hidden group">
                    ...
                    <div className="flex gap-4">
                        <div className="flex-1 bg-slate-50 p-4 rounded-xl text-center">
                            ...
                            <span className="block text-[10px] text-slate-400 uppercase">Validity</span>
                        </div>
                        <div className="flex-1 bg-slate-50 p-4 rounded-xl text-center">
...
const StandardsContent = () => (
    <section id="iso-standards-content" className="py-16 bg-white scroll-mt-24">
        <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {popularISOStandards.map((std, i) => (
                    <div key={i} className="p-8 bg-slate-50 rounded-3xl border border-slate-100 transition-all hover:bg-white hover:shadow-xl hover:border-[#1A7F7D]/20 space-y-4">
                        ...
                        <h5 className="font-bold text-slate-800 text-sm">{std.title}</h5>
                        <p className="text-xs text-slate-500 leading-relaxed italic">{std.detail}</p>
                    </div>
                ))}
            </div>
        </div>
...
const BenefitsContent = () => (
    <section id="iso-benefits-content" className="py-16 bg-slate-50/50 scroll-mt-24">
        <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {isoBenefits.map((item, i) => (
                    <div key={i} className="flex gap-4 p-6 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all">
                        <div className="w-10 h-10 bg-[#F0FDFA] text-[#1A7F7D] rounded-xl flex items-center justify-center shrink-0"><item.icon size={20} /></div>
                        <div>
                            <h6 className="font-bold text-slate-800 text-sm mb-1">{item.title}</h6>
...
const FrameworkContent = () => (
    <section id="iso-framework-content" className="py-16 bg-white scroll-mt-24">
        <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                {legalFramework.map((body, i) => (
                    <div key={i} className="p-8 bg-slate-900 rounded-3xl text-white relative group overflow-hidden">
                        ...
                        <p className="text-xs text-slate-400 leading-relaxed italic">{body.role}</p>
                    </div>
                ))}
            </div>
            <div className="mt-12 p-6 bg-[#E0F2F1] rounded-2xl border-l-4 border-l-[#1A7F7D] text-slate-700 italic text-sm text-center">
...
const DocumentsContent = () => (
    <section id="iso-documents-content" className="py-16 bg-slate-50/50 scroll-mt-24">
        <div className="max-w-7xl mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12">
                <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {isoDocuments.map((doc, i) => (
                            <div key={i} className="p-4 bg-white rounded-xl border border-slate-100 shadow-sm flex items-center gap-3">
                                <doc.icon size={16} className="text-[#C59B4E]" />
                                <span className="text-[10px] font-semibold text-slate-600 uppercase tracking-tight">{doc.name}</span>
                            </div>
                        ))}
                    </div>
                </div>
                <div className="space-y-6 pt-10">
                    <div className="p-8 bg-[#103B3E] rounded-3xl text-white">
                        <h4 className="text-lg font-bold text-[#C59B4E] mb-4 flex items-center gap-2"><DollarSign size={20} /> Pricing</h4>
                        ...
                        <ul className="space-y-3">
                            {isoCostTime.timeBreakdown.map((t, idx) => (
                                <li key={idx} className="flex gap-3 text-xs text-slate-300 italic group items-center">
...
const ProcessContent = () => (
    <section id="iso-process-content" className="py-24 bg-white scroll-mt-24">
        <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-7 gap-6 relative">
                {isoProcessSteps.map((step, idx) => (
                    <div key={idx} className="space-y-4">
                        ...
                        <p className="text-[10px] text-slate-500 leading-relaxed italic px-2 font-medium">{step}</p>
                    </div>
                ))}
            </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-12">
                ...
                <div className="p-8 bg-white border border-slate-100 rounded-3xl shadow-sm space-y-4">
                    ...
                    <p className="text-[11px] text-[#C59B4E] font-bold uppercase tracking-wider">Purpose: Check ongoing compliance.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="order-2 lg:order-1 lg:pr-10">
                    ...
                    <div className="grid sm:grid-cols-2 gap-6 pt-4">
                        <div className="space-y-4">
                            <h6 className="font-bold text-slate-800 flex items-center gap-2 text-sm"><CheckCircle className="text-[#1A7F7D]" size={16} /> End-to-End</h6>
                            <p className="text-[10px] text-slate-500 italic">Guidance from document prep to final certificate issuance.</p>
                        </div>
                        <div className="space-y-4">
                            <h6 className="font-bold text-slate-800 flex items-center gap-2 text-sm"><DollarSign className="text-[#1A7F7D]" size={16} /> Transparent</h6>
                            <p className="text-[10px] text-slate-500 italic">All-in-one packages with zero hidden costs.</p>
                        </div>
                        <div className="space-y-4">
                            <h6 className="font-bold text-slate-800 flex items-center gap-2 text-sm"><Clock className="text-[#1A7F7D]" size={16} /> Fast Processing</h6>
                            <p className="text-[10px] text-slate-500 italic">Approx. 13-15 working days turnaround for most standards.</p>
                        </div>
                        <div className="space-y-4">
                            <h6 className="font-bold text-slate-800 flex items-center gap-2 text-sm"><Scale className="text-[#1A7F7D]" size={16} /> Compliance</h6>
                            <p className="text-[10px] text-slate-500 italic">Ensuring adherence to IAF and legal regulations.</p>
                        </div>
                    </div>
                </div>
                <div className="order-1 lg:order-2 bg-[#103B3E] p-12 rounded-[40px] shadow-2xl relative overflow-hidden flex flex-col items-center">
                    ...
                    <button className="px-10 py-4 bg-[#C59B4E] hover:bg-[#a37d35] text-white font-bold uppercase tracking-widest text-xs rounded-full transition-all">Apply Now</button>
                </div>
            </div>
        </div>
    </section>
        ...
        <div className="min-h-screen font-sans w-full overflow-x-hidden text-slate-900 selection:bg-[#1A7F7D] selection:text-white">
            ...
            <section className="relative w-full min-h-[auto] lg:min-h-screen flex items-center pt-32 pb-12 lg:pt-36 lg:pb-20">
                <div className="absolute inset-0 z-0">
                    <img src={BackgroundImageSrc} alt="ISO Hero Background" className="w-full h-full object-cover" />
                        ...
                        <div className="w-full lg:w-1/2 flex flex-col items-start space-y-8">
                            <div className="relative w-28 h-28 flex items-center justify-center">
                                ...
                                <div className="relative w-full h-full bg-[#1a1a1a] rounded-full border-2 border-[#C59B4E] flex flex-col items-center justify-center p-2">
                                    ...
                                    <span className="text-[#C59B4E] font-bold text-[10px] text-center leading-tight uppercase mt-1">ISO <br /> Certification</span>
                                    <span className="text-white text-[8px] uppercase mt-1 opacity-70">Gold Standard</span>
                                </div>
                            </div>
                            <div className="space-y-4">
                                <h1 className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight font-serif italic">
                                    ...
                                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E0F2F1] to-[#80CBC4] not-italic text-5xl md:text-7xl">ISO Experts</span>
                                </h1>
                                <div className="space-y-3 pt-2">
                                    {isoIntroBullets.map((bullet, i) => (
                            ...
                            <div className="flex items-center gap-6 py-2 overflow-x-auto no-scrollbar w-full">
                                <div className="flex flex-col shrink-0">
                                    <span className="text-white text-2xl font-bold italic tracking-tighter uppercase">NABCB</span>
                                    <span className="text-slate-400 text-[10px] uppercase tracking-wider">Accredited</span>
                                </div>
                                <div className="h-10 w-[1px] bg-white/20"></div>
                                <div className="flex flex-col shrink-0">
                                    <span className="text-white text-2xl font-bold italic tracking-tighter uppercase">IAF</span>
                                    <span className="text-slate-400 text-[10px] uppercase tracking-wider">Certified</span>
                                </div>
                                <div className="h-10 w-[1px] bg-white/20"></div>
                                <div className="flex flex-col shrink-0">
                                    <span className="text-white text-2xl font-bold italic tracking-tighter uppercase">BIS</span>
                                    <span className="text-slate-400 text-[10px] uppercase tracking-wider">Compliance</span>
                                </div>
                            </div>
                        </div>
                        <div className="w-full max-w-md lg:w-[400px]">
                            <div className="bg-white rounded-[32px] shadow-2xl p-10 border border-white/10 relative overflow-hidden group">
                                <div className="absolute top-0 right-0 w-24 h-24 bg-[#C59B4E]/5 rounded-bl-full"></div>
                                <h2 className="text-2xl font-bold mb-2 text-center text-slate-800 tracking-tight">Apply Online</h2>
                                <p className="text-[11px] text-slate-500 mb-8 text-center uppercase tracking-widest font-semibold italic">Secure your certification with Bizzfiling</p>
