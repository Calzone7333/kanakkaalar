...
const SectionHeading = ({ subtitle, title, description, align = "center" }) => (
    <div className={`mb-12 ${align === "center" ? "text-center" : "text-left"}`}>
        <div className={`flex items-center gap-2 mb-3 ${align === "center" ? "justify-center" : "justify-start"}`}>
            <div className="h-0.5 w-8 bg-[#C59B4E]"></div>
            <span className="text-[#C59B4E] font-bold uppercase tracking-wider text-xs md:text-sm">{subtitle}</span>
            <div className="h-0.5 w-8 bg-[#C59B4E]"></div>
        </div>
        <h2 className="text-3xl md:text-4xl font-extrabold text-[#0D1B2A] mb-4 leading-tight">{title}</h2>
        <p className="text-slate-600 max-w-2xl mx-auto text-base md:text-lg leading-relaxed">{description}</p>
    </div>
);

const FeatureBox = ({ title, detail, icon: Icon }) => (
    <div className="flex items-start gap-4 p-6 bg-white border border-slate-100 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 group">
    ...
    <section id="society-overview-content" className="py-20 scroll-mt-24 px-4 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10">
            <div className="grid lg:grid-cols-2 gap-12 lg:items-center">
                <div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#E0F2F1] text-[#00695C] text-xs font-bold uppercase tracking-wider mb-6">
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                        <div className="p-5 bg-slate-50 rounded-xl border border-slate-200 hover:border-[#00695C]/30 transition-colors">
                            <h4 className="flex items-center gap-2 mb-3 text-lg font-bold text-slate-800">
                    ...
                    <div className="grid gap-4">
                        {societyEligibility.map((item, i) => (
                            <motion.div
                                ...
                                className="flex items-start gap-4 p-5 bg-white border border-slate-100 rounded-xl shadow-sm hover:shadow-md hover:border-[#00695C]/30 transition-all"
                            >
    ...
    <section id="society-documents-process-content" className="py-20 scroll-mt-24 px-4 bg-[#F8FAFC]">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-16">
                {/* Documents Column */}
                <div>
                    <h3 className="text-2xl font-bold text-[#0D1B2A] mb-8 flex items-center gap-3">
                    ...
                    <div className="space-y-4">
                        {societyRequiredDocuments.map((doc, i) => (
                            <div key={i} className="flex items-start gap-4 p-5 bg-white border border-slate-200 rounded-xl shadow-sm hover:shadow-md transition-all">
                                <div className="p-2 bg-slate-50 rounded-lg text-[#00695C]">
                                    <doc.icon className="w-5 h-5" />
                                </div>
                                <div>
                                    <h4 className="text-lg font-bold text-slate-800 mb-1">{doc.title}</h4>
                    ...
                    <div className="relative border-l-2 border-slate-200 ml-4 space-y-8 pb-4">
                        {societyRegistrationProcess.map((step, i) => (
                            <div key={i} className="relative pl-8 group">
                                ...
                                <h5 className="text-lg font-bold text-slate-800 mb-1">Step {i + 1}</h5>
                                <p className="text-slate-600 leading-relaxed text-sm lg:text-base">{step}</p>
                            </div>
                        ))}
                    </div>

                    <div className="mt-8 p-6 bg-[#FFF8E1] rounded-2xl border border-[#FFE082] text-center">
                        ...
                        <p className="text-xs text-amber-700 mt-4">*Government fees vary by state and state norms.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
                ...
                <div>
                    ...
                    <div className="bg-[#E0F2F1] rounded-2xl p-8 border border-[#B2DFDB]">
                        <h4 className="flex items-center gap-2 mb-6 text-xl font-bold text-[#00695C]">
                            <RefreshCw className="w-6 h-6" /> Online Renewal Steps
                        </h4>
                        <ul className="space-y-4">
                            {societyRenewalProcess.map((step, i) => (
                                <li key={i} className="flex items-start gap-3">
                                    <div className="w-6 h-6 rounded-full bg-white text-[#00695C] border border-[#00695C] flex items-center justify-center font-bold text-xs flex-shrink-0 mt-0.5">
                                        {i + 1}
                                    </div>
...
const SocietyWhyBizzfiling = () => (
    <section id="society-why-Bizzfiling" className="py-20 scroll-mt-24 bg-[#F8FAFC]">
        <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="bg-[#E0F7FA] p-6 rounded-xl border-l-[6px] border-[#006064] shadow-md max-w-4xl mx-auto">
