                ...
                <div className="space-y-8">
                    <div className="prose prose-slate prose-lg">
                        <p className="text-slate-600 leading-relaxed text-lg">
                            Your brand name and logo are your most valuable assets. Don't let others profit from your hard work. <span className="text-[#1A7F7D] font-bold">Bizzfiling's</span> IP attorneys manage the entire international filing process via the Madrid Protocol or direct filing routes.
                        </p>
                    </div>
                    <div className="grid sm:grid-cols-2 gap-5">
                        {[
                            { text: "Madrid Protocol", icon: Shield },
                            { text: "Worldwide Search", icon: Search },
                            { text: "130+ Countries", icon: Globe },
                            { text: "Expert IP Lawyers", icon: Scale }
                        ].map((item, idx) => (
                    ...
                    <div className="relative p-10 bg-[#0F2D30] rounded-[2.5rem] text-center text-white border-b-8 border-[#C59B4E] shadow-2xl">
                        ...
                        <div className="mt-8 pt-8 border-t border-white/10 grid grid-cols-2 gap-5">
                            <div className="text-left">
                                <p className="text-sm text-slate-400 font-bold uppercase mb-1">Protection</p>
                                <p className="text-lg font-bold">Comprehensive</p>
                            </div>
                            <div className="text-right">
                                <p className="text-sm text-slate-400 font-bold uppercase mb-1">Process</p>
                                <p className="text-lg font-bold">Managed</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="methods-content" className="py-20 bg-white scroll-mt-24">
        <div className="max-w-7xl mx-auto px-6">
            <SectionHeading
                ...
                description="Select the most efficient route for your international brand expansion."
            />
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                {filingMethods.map((item, i) => (
                    <div
                        key={i}
        ...
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="mt-20 p-10 bg-[#0F2D30] rounded-[2.5rem] shadow-2xl flex flex-col lg:flex-row items-center justify-between gap-10">
                <div className="space-y-8 text-center lg:text-left">
                    <h3 className="text-3xl font-extrabold text-white">Protect Multiple Trademarks?</h3>
                    <p className="text-slate-300 text-lg">We offer special packages for startups protecting brand names, logos, and taglines.</p>
                </div>
            ...
            <div className="flex flex-col lg:flex-row gap-20 items-stretch">
                        ...
                        {trademarkDocuments.map((doc, i) => (
                            <div key={i} className="group flex items-center gap-10 p-8 bg-white rounded-2xl border border-slate-100 hover:border-[#1A7F7D]/30 hover:shadow-xl transition-all duration-300">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500 font-medium">Digital scanned copies</p>
                                </div>
                ...
                <div className="w-full lg:w-2/5 flex flex-col">
                    <div className="flex-grow bg-[#0F2D30] p-10 rounded-[2.5rem] text-white relative overflow-hidden shadow-2xl flex flex-col items-center text-center justify-center">
                        ...
                        <h3 className="text-3xl font-extrabold mb-6">Basic TM Mandatory</h3>
                        <p className="text-slate-300 mb-10 text-lg font-medium leading-relaxed">
                            To file via the Madrid Protocol, you must already have a filed or registered trademark in your base country (e.g., India).
                        </p>
                        <div className="w-full space-y-8">
                            ...
                            <p className="text-sm text-slate-400 font-bold uppercase tracking-widest">WIPO Standards</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div className="w-full lg:w-3/5 space-y-8">
                            ...
                            <div className="flex gap-10 pt-2">
                                <div className="flex items-center gap-5 text-white/90 text-sm md:text-sm font-bold">
                                    <CheckCircle size={18} className="text-[#C59B4E]" /> Madrid Protocol
                                </div>
                                <div className="flex items-center gap-5 text-white/90 text-sm md:text-sm font-bold">
                                    <Shield size={18} className="text-[#C59B4E]" /> Certified IP Lawyers
                                </div>
                            </div>
                        </div>
                        <div className="w-full max-w-sm">
                            <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-100">
                                <div className="p-8 md:p-8">
                                    <h3 className="text-xl font-bold text-slate-800 text-center mb-6">Secure Your Brand</h3>
                                    <LeadForm serviceName="International Trademark Registration" btnText="Start Filing" />
                                </div>
                            </div>
                        </div>
                    </div>
