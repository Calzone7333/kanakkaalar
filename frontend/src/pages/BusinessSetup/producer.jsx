            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center mb-16">
                <div className="space-y-8">
                    ...
                    <div className="flex flex-wrap gap-5">
                        <span className="px-4 py-2 bg-white rounded-lg border border-slate-200 text-sm font-semibold text-slate-700 shadow-sm">Farmer Empowerment</span>
                        <span className="px-4 py-2 bg-white rounded-lg border border-slate-200 text-sm font-semibold text-slate-700 shadow-sm">Scale Efficiencies</span>
                        <span className="px-4 py-2 bg-white rounded-lg border border-slate-200 text-sm font-semibold text-slate-700 shadow-sm">FPO Scheme Eligible</span>
                    </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
                <div className="p-8 bg-slate-50 rounded-2xl border border-slate-100 space-y-8">
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed">Run your farm like a business with professional directors and management.</p>
                </div>
                <div className="p-8 bg-slate-50 rounded-2xl border border-slate-100 space-y-8">
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed">Unlike a cooperative, it offers the legal autonomy and continuity of a company.</p>
                </div>
                <div className="p-8 bg-slate-50 rounded-2xl border border-slate-100 space-y-8">
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed">Membership can be easily managed and transferred within the producer community.</p>
                </div>
                <div className="p-8 bg-slate-50 rounded-2xl border border-slate-100 space-y-8">
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed">Gain priority access to SFAC and NABARD support for equity and credit links.</p>
                </div>
            </div>
        </div>
    </section>
...
const PricingContent = () => (
    <section id="pricing-content" className="py-12 md:py-16 bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-4">
            ...
            <PricingCards plans={producerPlans} serviceName="Producer Company" />
        </div>
    </section>
);
    ...
    <section id="requirements-content" className="py-12 md:py-16 bg-white scroll-mt-24">
        <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                {producerRequirements.map((item, i) => (
                    <div
                        key={i}
        ...
        <div className="min-h-screen font-sans w-full overflow-x-hidden text-slate-900 selection:bg-[#1A7F7D] selection:text-white">
            ...
            <section className="relative w-full min-h-[500px] flex items-center pt-24 pb-12 lg:pt-32 lg:pb-12 md:pb-16 text-left">
                <div className="absolute inset-0 z-0">
                    <img src={BackgroundImageSrc} alt="Producer Registration" className="w-full h-full object-cover" />
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                        <div className="w-full lg:w-3/5 space-y-8">
                            <div className="inline-flex items-center gap-5 px-4 py-1.5 bg-white/10 backdrop-blur rounded-full border border-white/20">
                                ...
                                <span className="text-white text-sm md:text-sm uppercase font-bold tracking-[0.2em]">Verified Farmer Producer Support</span>
                            </div>
                            <h1 className="text-2xl md:text-3xl lg:text-3xl font-extrabold text-white leading-tight">
                                Producer Company <br className="hidden lg:block" />
                            ...
                            <p className="text-sm md:text-base text-slate-300 max-w-lg font-light leading-relaxed">
                                Empower your agricultural community. Build a robust Farmer Producer Organization (FPO) with us. Connect with experts for reliable producer company formation.
                            </p>
                            <div className="flex gap-10 pt-2">
                                <div className="flex items-center gap-5 text-white/90 text-sm md:text-sm font-bold">
                                    <CheckCircle size={18} className="text-[#C59B4E]" /> FPO Eligible
                                </div>
                                <div className="flex items-center gap-5 text-white/90 text-sm md:text-sm font-bold">
                        ...
                        <div className="w-full max-w-sm">
                            <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-100">
                                <div className="p-8 md:p-8">
                                    ...
                                    <LeadForm serviceName="Producer Company Registration" btnText="Start Registration" />
                                </div>
                            </div>
                        </div>
                    </div>
